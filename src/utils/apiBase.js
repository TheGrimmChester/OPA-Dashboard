 ...
 * Absolute defaults apply only when VITE_API_URL is also unset (local Vite).
 */
const AGENT_URL = import.meta.env.VITE_API_URL || ''
const ORCH_URL = import.meta.env.VITE_ORCHESTRATOR_URL || AGENT_URL || 'http://localhost:8091'
const PERF_URL = import.meta.env.VITE_PERF_LAB_URL || AGENT_URL || 'http://localhost:8092'
